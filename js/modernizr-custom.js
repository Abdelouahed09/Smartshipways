...
!(function (window, document, undefined) {
  ...
  isSVG ||
    !(function (A, e) {
      ...
      function i(A) {
        var e = g[A[f]];
        return e || ((e = {}), E++, (A[f] = E), (g[E] = e)), e;
      }
      function o(A, t, n) {
        if ((t || (t = e), l)) return t.createElement(A);
        n || (n = i(t));
        var r;
        return (
          (r = n.cache[A]
            ...
            : n.createElem(A)),
          !r.canHaveChildren || m.test(A) || r.tagUrn
            ? r
            : n.frag.appendChild(r)
        );
      }
      function a(A, t) {
        if ((A || (A = e), l)) return A.createDocumentFragment();
        t = t || i(A);
        for (
          var r = t.frag.cloneNode(), o = 0, a = n(), d = a.length;
          d > o;
          o++
        )
          r.createElement(a[o]);
      ...
      function d(A, e) {
        e.cache ||
          ...
          (A.createElement = function (t) {
            return D.shivMethods ? o(t, A, e) : e.createElem(t);
          }),
  ...
  !(function () {
    ...
    Modernizr.addAsyncTest(function () {
      ...
      try {
        ...
        try {
          r = new Blob([c], { type: "text/javascript" });
        } catch (l) {}
        r || ((i = new t()), i.append(c), (r = i.getBlob())),
